	...
	$.extend({
		...
		pnotify: function(options) {
			...
			pnotify.pnotify_display = function() {
				...
				pnotify.wrap('<div class="ligth notify removeme"></div>');
			};
			...
			if (opts.pnotify_history) {
				...
				if (typeof body_history == "undefined") {
					...
					.append($("<div />", {"class": "ui-pnotify-history-header", "text": "Volver a mostrar"}))
					.append($("<button />", {
					...
					.appendTo(body).wrap('<div class="ligth notify"></div>');
